...
SELECT LENGTH(first_name)+LENGTH(last_name)  'Length of  Names' FROM employees;
...
SELECT first_name "Name",LENGTH(first_name) "Length" FROM employees WHERE first_name LIKE 'J%'
...
WHERE 20 >= (SELECT COUNT(DISTINCT UnitPrice) FROM Products AS b WHERE b.UnitPrice >= a.UnitPrice)
